...
def test_binary() -> None:
    ...
    (game / "jkx.x86_64.exe").write_text("", encoding="ascii")
    check(verify.find_binary(game, None) == game / "jkx.x86_64.exe",
