...
// The PC_* parser moved to qcommon/pc_parse.cpp. It reads files and advances a
// parse session that q_shared.cpp owns; neither of those is a menu, and the
// client had to include this file's private header to reach it.
/*
=================
Menu_Count
=================
