...
void VBO_GetDeviceBuffer( DrawItem& item ) 
{
	...
	item.draw.params.indexed.world.ibo_items =  (VkMultiDrawIndexedInfoEXT *)ri.Hunk_Alloc( vbo->ibo_items_count * sizeof(*item.draw.params.indexed.world.ibo_items), h_low );
