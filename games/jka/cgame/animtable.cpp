...
// The animation name table, and the only definition of it.
//
...
// anims.h declares structures that name types from bg_public.h, so that has to
// come first. This is the gamecode's own include order, not a new requirement.
#include "../game/bg_public.h"
#include "../game/anims.h"
#include "api/anim_names.h"

stringID_table_t animTableAcademy [MAX_ANIMATIONS+1] =
{
	//=================================================
	//HEAD ANIMS
	//=================================================
